...
import { RoundStamp, Skyline } from './Decor'
      ...
      <div className="flex h-full flex-col px-6 py-7 sm:px-9 sm:py-8">
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0 flex-1">
            <SectionTitle icon={BookOpen} rule={false}>Livros em destaque</SectionTitle>
            <p className="mt-1.5 text-[11.5px] leading-relaxed text-slate-700 sm:mt-2.5 sm:text-[13px]">
              {authorName} estará na Bienal do Livro de São Paulo 2026 entre os dias 4 e 13 de setembro.
            </p>
          </div>
        </div>
