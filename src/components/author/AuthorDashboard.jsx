...
export default function AuthorDashboard() {
  ...
  const uploadPhoto = async file => {
    ...
    try {
      ...
      const path = `${account.authorId}/drafts/${Date.now()}.${optimized.extension}`
      ...
      setNotice(`Foto enviada (${Math.round(optimized.size / 1024)} KB). Agora clique em “Salvar rascunho” ou “Enviar para revisão” para vinculá-la ao perfil.`)
